...
for gm in range(1,gra):
    ...
    if gm > 0 and gm <= 6:
        ...
        globals()[f'grass{gm}_y_pos'] = 100
    if gm > 6 and gm <= 12: 
        globals()[f'grass{gm}_x_pos'] = (screen_width/6)*(gm - 7) + 18
        globals()[f'grass{gm}_y_pos'] = 100 + (18 + globals()[f'grass{gm}_height'])
    if gm > 12 and gm <= 18:
        globals()[f'grass{gm}_x_pos'] = (screen_width/6)*(gm - 13) + 18
        globals()[f'grass{gm}_y_pos'] = 100 + (18 + globals()[f'grass{gm}_height'])*2
    if gm > 18 and gm <= 24:
        globals()[f'grass{gm}_x_pos'] = (screen_width/6)*(gm - 19) + 18
        globals()[f'grass{gm}_y_pos'] = 100 + (18 + globals()[f'grass{gm}_height'])*3
                    ...
                    if gm2 == 3 or gm2 == 5 or gm2 == 7 or gm2 == 9:
                        ...
                        for gm3 in range(1,gra):
                            ...
                            if gm3 > 0 and gm3 <= 6:
                                ...
                                globals()[f'grass{gm3}_y_pos'] = 100
                            if gm3 > 6 and gm3 <= 12: 
                                globals()[f'grass{gm3}_x_pos'] = (screen_width/6)*(gm3 - 7) + 18
                                globals()[f'grass{gm3}_y_pos'] = 100 + (18 + globals()[f'grass{gm3}_height'])
                            if gm3 > 12 and gm3 <= 18:
                                globals()[f'grass{gm3}_x_pos'] = (screen_width/6)*(gm3 - 13) + 18
                                globals()[f'grass{gm3}_y_pos'] = 100 + (18 + globals()[f'grass{gm3}_height'])*2
                            if gm3 > 18 and gm3 <= 24:
                                globals()[f'grass{gm3}_x_pos'] = (screen_width/6)*(gm3 - 19) + 18
                                globals()[f'grass{gm3}_y_pos'] = 100 + (18 + globals()[f'grass{gm3}_height'])*3
                    else:
