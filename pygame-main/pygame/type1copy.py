...
# end 만들기
end = pygame.image.load(os.path.join(image_path, "end.png"))

# 주민 만들기
citizen_img_idx = pygame.image.load(os.path.join(image_path, "citizen_back.png"))
...
citizen_speed = random.randint(20,20)
citizen_way = random.randint(0,1)
citizen_images =[
    pygame.image.load(os.path.join(image_path, "citizen_back.png")),
    pygame.image.load(os.path.join(image_path, "citizen_front.png"))]
#2
citizen1_img_idx = pygame.image.load(os.path.join(image_path, "citizen_back.png"))
...
citizen1_speed = random.randint(20,20)
citizen1_way = random.randint(0,1)
citizen1_images =[
    pygame.image.load(os.path.join(image_path, "citizen_back.png")),
    pygame.image.load(os.path.join(image_path, "citizen_front.png"))]
#3
citizen2_img_idx = pygame.image.load(os.path.join(image_path, "citizen_back.png"))
...
citizen2_speed = random.randint(20,20)
citizen2_way = random.randint(0,1)
citizen2_images =[
    pygame.image.load(os.path.join(image_path, "citizen_back.png")),
    pygame.image.load(os.path.join(image_path, "citizen_front.png"))]

citizen3_img_idx = pygame.image.load(os.path.join(image_path, "citizen_back.png"))
citizen3_size = citizen3_img_idx.get_rect().size
citizen3_width = citizen3_size[0]
citizen3_height = citizen3_size[1]
citizen3_x_pos = random.randint(((screen_width - citizen_width)/3)*2,screen_width - citizen_width)
citizen3_y_pos = random.randint(0,screen_height)
citizen3_speed = random.randint(20,20)
...
while running:
    ...
    if character_rect.colliderect(end_rect):
            game_over = True
    game_result = "clear"
    ...
    citizen3_rect = citizen2_img_idx.get_rect()
    citizen3_rect.left = citizen2_x_pos
    citizen3_rect.top = citizen2_y_pos
    #집 rect
