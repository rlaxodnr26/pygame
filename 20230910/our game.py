...
character_images= [
    ...
    pygame.image.load(os.path.join(image_path, "charcter_left.png")),
    pygame.image.load(os.path.join(image_path, "character_left1.png")),
    pygame.image.load(os.path.join(image_path, "character_left2.png")),
    pygame.image.load(os.path.join(image_path, "character_right.png")),
    pygame.image.load(os.path.join(image_path, "character_right1.png")),
    pygame.image.load(os.path.join(image_path, "charcter_right2.png")),
    pygame.image.load(os.path.join(image_path, "charcter_back1.png")),
    pygame.image.load(os.path.join(image_path, "charcter_back2.png")),
    pygame.image.load(os.path.join(image_path, "charcter_back3.png"))]
...
citizen_x_pos = random.randint(200,(screen_width - citizen_width)/5)
citizen_y_pos = random.randint(0,screen_height)
citizen_speed = random.randint(spdm, spdM)
...
citizen1_x_pos = random.randint((screen_width - citizen_width)/5,((screen_width - citizen_width)/5)*2)
citizen1_y_pos = random.randint(0,screen_height)
citizen1_speed = random.randint(spdm,spdM)
...
citizen2_x_pos = random.randint(((screen_width - citizen_width)/5)*2,((screen_width - citizen_width)/5)*3)
citizen2_y_pos = random.randint(0,screen_height)
citizen2_speed = random.randint(spdm,spdM)
citizen2_way = random.randint(0,1)
citizen2_images =[
    pygame.image.load(os.path.join(image_path, "citizen1.png")),
    pygame.image.load(os.path.join(image_path, "citizen2.png"))]
#4
citizen3_img_idx = pygame.image.load(os.path.join(image_path, "citizen1.png"))
citizen3_size = citizen3_img_idx.get_rect().size
citizen3_width = citizen3_size[0]
citizen3_height = citizen3_size[1]
citizen3_x_pos = random.randint(((screen_width - citizen_width)/5)*3,((screen_width - citizen_width)/5)*4)
citizen3_y_pos = random.randint(0,screen_height)
citizen3_speed = random.randint(spdm,spdM)
citizen3_way = random.randint(0,1)
citizen3_images =[
    pygame.image.load(os.path.join(image_path, "citizen1.png")),
    pygame.image.load(os.path.join(image_path, "citizen2.png"))]

#5
citizen4_img_idx = pygame.image.load(os.path.join(image_path, "citizen1.png"))
citizen4_size = citizen4_img_idx.get_rect().size
citizen4_width = citizen4_size[0]
citizen4_height = citizen4_size[1]
citizen4_x_pos = random.randint(((screen_width - citizen_width)/5)*4,(screen_width - citizen_width))
citizen4_y_pos = random.randint(0,screen_height)
citizen4_speed = random.randint(spdm,spdM)
citizen4_way = random.randint(0,1)
citizen4_images =[
    pygame.image.load(os.path.join(image_path, "citizen1.png")),
    pygame.image.load(os.path.join(image_path, "citizen2.png"))]
...
while running:
    ...
    citizen3_rect = citizen3_img_idx.get_rect()
    citizen3_rect.left = citizen3_x_pos
    citizen3_rect.top = citizen3_y_pos
    
    citizen4_rect = citizen4_img_idx.get_rect()
    citizen4_rect.left = citizen4_x_pos
    citizen4_rect.top = citizen4_y_pos
    ...
    while (True):
        msg = game_font.render(str(score)+" / 5", True, (255, 255, 0)) # 노란색
        ...
        if character_rect.colliderect(citizen2_rect):
            ...
            if score < 5:
                score -= 1
        if character_rect.colliderect(citizen3_rect):
            character_x_pos = 50
            character_y_pos = screen_height/2
            if score < 5:
                score -= 1
        if character_rect.colliderect(citizen4_rect):
            character_x_pos = 50
            character_y_pos = screen_height/2
            if score < 5:
                score -= 1"""
        ...
        if citizen2_y_pos > 0 and citizen2_y_pos < screen_height - citizen2_height:
            ...
            if citizen2_rect.colliderect(house1_rect_bottomline):
                citizen2_way = 0
            elif citizen2_rect.colliderect(house2_rect_topline):
                citizen2_way = 1
        ...
        # 시민4
        if citizen3_y_pos > 0 and citizen3_y_pos < screen_height - citizen3_height:
            if citizen3_way == 0:
                citizen3_y_pos = citizen3_y_pos + citizen3_speed
            if citizen3_way == 1:
                citizen3_y_pos = citizen3_y_pos - citizen3_speed
            if citizen3_rect.colliderect(house1_rect_bottomline):
                citizen3_way = 0
            elif citizen3_rect.colliderect(house2_rect_topline):
                citizen3_way = 1

        elif citizen3_y_pos <= 0 or citizen3_y_pos >= screen_height - citizen3_height:        
            if citizen3_y_pos <= 0:
                citizen3_y_pos = 0.1
                citizen3_way = 0

            if citizen3_y_pos >= screen_height - citizen3_height:
                citizen3_y_pos = screen_height - citizen3_height - 0.1
                citizen3_way = 1

        

        #시민 5
        if citizen4_y_pos > 0 and citizen4_y_pos < screen_height - citizen4_height:
            if citizen4_way == 0:
                citizen4_y_pos = citizen4_y_pos + citizen4_speed
            if citizen4_way == 1:
                citizen4_y_pos = citizen4_y_pos - citizen4_speed

            if citizen4_rect.colliderect(house2_rect_topline):
                citizen4_way = 1

        elif citizen4_y_pos <= 0 or citizen4_y_pos >= screen_height - citizen4_height:        
            if citizen4_y_pos <= 0:
                citizen4_y_pos = 0.1
                citizen4_way = 0

            if citizen4_y_pos >= screen_height - citizen4_height:
                citizen4_y_pos = screen_height - citizen4_height - 0.1
                citizen4_way = 1
    ...
    screen.blit(character_images[cha_img], (character_x_pos, character_y_pos))
    ...
    screen.blit(citizen3_images[not(citizen3_way)], (citizen3_x_pos, citizen3_y_pos))
    screen.blit(citizen4_images[not(citizen4_way)], (citizen4_x_pos, citizen4_y_pos))
